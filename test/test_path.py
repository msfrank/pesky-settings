...
class TestPath(unittest.TestCase):
    ...
    def test_make_path_from_string_with_a_single_segment(self):
        ...
        path = pesky.settings.path.make_path("foobar")
    ...
    def test_make_path_from_string_with_multiple_segments(self):
        ...
        path = pesky.settings.path.make_path("foo.bar.baz")
    ...
    def test_make_path_from_string_with_quoted_segments(self):
        ...
        path = pesky.settings.path.make_path('foo."bar baz".qux')
    ...
    def test_make_path_from_single_path(self):
        ...
        path1 = pesky.settings.path.make_path("foobar")
        path2 = pesky.settings.path.make_path(path1)
    ...
    def test_make_path_from_a_list_of_paths(self):
        ...
        path1 = pesky.settings.path.make_path("foo")
        path2 = pesky.settings.path.make_path("bar")
        path3 = pesky.settings.path.make_path("baz")
        path = pesky.settings.path.make_path(path1, path2, path3)
        self.assertListEqual(path.segments, ["foo", "bar", "baz"])
